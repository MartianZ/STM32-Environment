...
#define LED_SCL_LOW GPIO_ResetBits(GPIOE, GPIO_Pin_3)
#define LED_SCL_HIGH GPIO_SetBits(GPIOE, GPIO_Pin_3)

#define LED_SDA_LOW GPIO_ResetBits(GPIOE, GPIO_Pin_2)
#define LED_SDA_HIGH GPIO_SetBits(GPIOE, GPIO_Pin_2)
#define LED_RST_LOW GPIO_ResetBits(GPIOE, GPIO_Pin_1)
#define LED_RST_HIGH GPIO_SetBits(GPIOE, GPIO_Pin_1)
#define LED_DC_LOW GPIO_ResetBits(GPIOE, GPIO_Pin_0)
#define LED_DC_HIGH GPIO_SetBits(GPIOE, GPIO_Pin_0)
...
//======================================================
// 128X64OLEDòo?§μ×2??y?ˉ[8X16]×?ì??a
// éè????: Guokaiyi
// ?è  ê?: [8X16]?÷??×?·?μ?×??￡êy?Y (×Y?òè??￡,×??úμ1Dò)
...
VOID LED_PrintShort(UCHAR8 ucIdxX, UCHAR8 ucIdxY, CHAR8 sData)
{
